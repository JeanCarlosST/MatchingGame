...
{ /// <summary>
/// /Arregla namespace de los controladores
/// </summary>
    [ApiController]
    [Route("[controller]")]
    public class UserController : ControllerBase
    {
        ...
        public UserController(ILogger<UserController> logger, Contexto context, IConfiguration configuration, IHttpClientFactory httpClientFactory)
        {
            this.logger = logger;
